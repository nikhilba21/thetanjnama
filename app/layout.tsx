          ...
          <footer className="site-footer">
            <div className="container footer-grid">
              <div className="footer-brand">
                <img src="/logo.webp" alt="TANJNAMA — सोच पर तंज, सच के साथ" className="footer-logo-img" width="180" height="120" loading="lazy" decoding="async" />
                <p style={{ fontSize: '13px', lineHeight: '1.7', color: '#cbd5e1', marginTop: '8px' }}>
            ...
            <div className="footer-bottom">
              <div className="container footer-bottom-inner">
                ...
                <p style={{ color: '#cbd5e1' }}>सोच पर तंज, सच के साथ</p>
              </div>
            </div>
          </footer>
        </div>
